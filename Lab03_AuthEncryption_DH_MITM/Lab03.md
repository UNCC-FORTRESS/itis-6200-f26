...
Alice wants to send Bob a message providing both **confidentiality** and **integrity**. Using **CyberChef** (cyberchef.io), evaluate each of 9 candidate schemes using your own personalized parameters (below), and determine which scheme(s) actually deliver both properties.
