...
NetLab is hosted externally at https://netlab.thecybersecguru.com — it's a third-party tool the course doesn't control, so the occasional hiccup can happen. A self-contained fallback with no third-party dependency exists at [NetworkSim.html](https://uncc-fortress.github.io/itis-6200-f26/Lab10_NetworkSecurity/tools/NetworkSim.html) if NetLab is acting up.
